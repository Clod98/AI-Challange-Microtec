# -*- coding: utf-8 -*-
"""
Created on Thu Nov 10 15:44:30 2022
...
fold = "C:/Users/39345/Desktop/Microtec challange/Infologs/Infologs/"


ext = list(range(0,29))
columns = ["LogID","N.knots","Avg_knot_radius"]
columns.extend(ext)
...
print(df)
df.to_csv("mats.csv", index=False)
